...
- (void)initControlBtn {
    UIButton *cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(15, self.view.frame.size.height - 60.0f, 100, 50)];
    cancelBtn.backgroundColor = [UIColor colorWithRed:0.149 green:0.149 blue:0.149 alpha:0.6];
    ...
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.view.frame.size.width - 115.0f, self.view.frame.size.height - 60.0f, 100, 50)];
    confirmBtn.backgroundColor = [UIColor colorWithRed:0.149 green:0.149 blue:0.149 alpha:0.6];
    confirmBtn.layer.cornerRadius = 15.f;

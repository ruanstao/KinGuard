...
//使用图片，通过sb
- (IBAction)selectImageFormAlbumUseSb:(id)sender {
    [self selectImageFormAlbum:sender];
}
...
//点击照明<sb使用>
- (IBAction)openTorchUseSb:(id)sender {
    [self openTorch:sender];
}

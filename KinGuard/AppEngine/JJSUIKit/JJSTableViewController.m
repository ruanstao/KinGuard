...
#import "JJSTableViewController.h"
...
@interface JJSTableViewController()
@property (strong, nonatomic) UIButton *backBtn;
@property (strong, nonatomic) UIView *errorView;
@property (strong, nonatomic) UIView *noNetWorkView;
@end
@implementation JJSTableViewController
#pragma mark -
            ...
            if ([obj isKindOfClass:[UIImageView class]]) {
                ...
                for (id obj2 in list2) {
                    if ([obj2 isKindOfClass:[UIImageView class]]) {
                        ...
                        [customView setFrame:(CGRect){imageView2.left,imageView2.top - 0.5,imageView2.width,1}];
...
- (void)showBackButton:(BOOL)show
{
    ...
    if (mIsIOS7OrLater)
    {
        self.backBtn.imageEdgeInsets = UIEdgeInsetsMake(7, -9, 7, 90);
    ...
    [self.backBtn setImage:mImageByName(@"btn_back") forState:UIControlStateNormal];
